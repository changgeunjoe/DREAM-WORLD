...
//	auto& characters = roomRef.GetCharactersInfo();
//
//	for (auto& playCharacter : characters) {
//		bool isExist = false;
//		for (auto& player : playerMap)
//			if (player.second == playCharacter.first)
//				isExist = true;
//		if (!isExist) continue;
...
//}
//
//float SmallMonsterSessionObject::GetDistance(const XMFLOAT3& point)
//{
//	XMFLOAT3 position = point;
//	return Vector3::Length(Vector3::Subtract(position, m_position));
//}
//
...
//	if (roomRef.GetStageState() == ROOM_STATE::ROOM_STAGE1)//stage1이라면
//	{
