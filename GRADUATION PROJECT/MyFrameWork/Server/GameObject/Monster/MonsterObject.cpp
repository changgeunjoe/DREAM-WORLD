...
//#include "../Character/ChracterSessionObject.h"
...
//{
//	if (isMove) {
//		auto characterInfo = g_RoomManager.GetRunningRoomRef(m_roomId).GetCharactersInfo();
//		XMFLOAT3 destinationPlayerPos = characterInfo[m_aggroPlayerRole]->GetPos();
//
...
//	ROLE currentAggroRole = m_aggroPlayerRole;
//
...
//	}
//	auto characterInfo = g_RoomManager.GetRunningRoomRef(m_roomId).GetCharactersInfo();
//	XMFLOAT3 pPos = characterInfo[m_aggroPlayerRole]->GetPos();
//
//	m_reserveRoadLock.lock();
...
//		m_reserveRoadLock.unlock();
//		SERVER_PACKET::BossMoveNodePacket sendPacket{SERVER_PACKET::BOSS_MOVE_NODE, m_position, currentAggroRole};
