...
//
//
//class ChracterSessionObject : public GameObject
//{
//
//
//	//SkillManager로 구분하자
...
//public:
//	virtual void Skill_1(const XMFLOAT3& posOrDir) = 0;
//	virtual void Skill_2(const XMFLOAT3& posOrDir) = 0;
//	bool IsDurationEndTimeSkill_1();
//	bool IsDurationEndTimeSkill_2();
//	virtual void ExecuteCommonAttack(const XMFLOAT3& attackDir, int power) = 0;
//protected://collision
...
//	std::pair<bool, XMFLOAT3> CheckCollisionBossMonster(XMFLOAT3& moveDirection, float ftimeElapsed = 0.01768f);
...
//
//	void Skill_1(const XMFLOAT3& posOrDir)override;
//	void Skill_2(const XMFLOAT3& posOrDir)override;
//	virtual void ExecuteCommonAttack(const XMFLOAT3& attackDir, int power) override;
//};
//
