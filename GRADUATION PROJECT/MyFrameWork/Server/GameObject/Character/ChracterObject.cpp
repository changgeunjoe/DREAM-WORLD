...
//#include "../Monster/MonsterSessionObject.h"
...
//}
//
//std::pair<float, XMFLOAT3> ChracterSessionObject::GetNormalVectorSphere(const XMFLOAT3& point)
//{
//	XMFLOAT3 position = point;
//	XMFLOAT3 normalVec = Vector3::Subtract(m_position, position);
...
//	auto playerMap = roomRef.GetPlayerInfo();
//	for (auto& playCharacter : roomRef.GetCharactersInfo()) {
...
//{
//	Room& roomRef = g_RoomManager.GetRunningRoomRef(m_roomId);
//	const MonsterSessionObject& boss = roomRef.GetBoss();
//	
...
//	if (roomRef.GetStageState() == ROOM_STAGE1) {
...
//		return false;
//	}
//	else if (roomRef.GetStageState() == ROOM_BOSS) {
...
//
//
//void WarriorSessionObject::Skill_1(const XMFLOAT3& posOrDir)
//{
//	Room& roomRef = g_RoomManager.GetRunningRoomRef(m_roomId);
...
//}
//
//void WarriorSessionObject::Skill_2(const XMFLOAT3& posOrDir)
//{
//	auto currentTime = std::chrono::high_resolution_clock::now();
...
//}
//
//void WarriorSessionObject::ExecuteCommonAttack(const XMFLOAT3& attackDir, int power)
//{
//	Room& roomRef = g_RoomManager.GetRunningRoomRef(m_roomId);
...
//}
//
//void MageSessionObject::Skill_1(const XMFLOAT3& posOrDir)
//{
//	auto currentTime = std::chrono::high_resolution_clock::now();
//	auto durationTime = std::chrono::duration_cast<std::chrono::seconds>(currentTime - m_prevSkillInputTime[0]);
//	if (m_skillCoolTime[0] > durationTime)	return;
...
//}
//
//void MageSessionObject::Skill_2(const XMFLOAT3& posOrDir)
//{
//	auto currentTime = std::chrono::high_resolution_clock::now();
//	auto durationTime = std::chrono::duration_cast<std::chrono::seconds>(currentTime - m_prevSkillInputTime[1]);
//	if (m_skillCoolTime[1] > durationTime)	return;
...
//}
//
//void MageSessionObject::ExecuteCommonAttack(const XMFLOAT3& attackDir, int power)
//{
//	Room& roomRef = g_RoomManager.GetRunningRoomRef(m_roomId);
//	//offset 적용 안됨
...
//}
//
//void TankerSessionObject::Skill_1(const XMFLOAT3& posOrDir)
//{
//	auto currentTime = std::chrono::high_resolution_clock::now();
//	auto durationTime = std::chrono::duration_cast<std::chrono::seconds>(currentTime - m_prevSkillInputTime[0]);
//	if (m_skillCoolTime[0] > durationTime)	return;
...
//	SERVER_PACKET::NotifyPacket sendPacket{SERVER_PACKET::SHIELD_START};
//	g_RoomManager.GetRunningRoomRef(m_roomId).BroadCastPacket(reinterpret_cast<char*>(&sendPacket));	
//}
//
//void TankerSessionObject::Skill_2(const XMFLOAT3& posOrDir)
//{
//	auto currentTime = std::chrono::high_resolution_clock::now();
//	auto durationTime = std::chrono::duration_cast<std::chrono::seconds>(currentTime - m_prevSkillInputTime[1]);
//	if (m_skillCoolTime[1] > durationTime)	return;
...
//}
//
//void TankerSessionObject::ExecuteCommonAttack(const XMFLOAT3& attackDir, int power)
//{
//	Room& roomRef = g_RoomManager.GetRunningRoomRef(m_roomId);
...
//}
//
//void ArcherSessionObject::Skill_1(const XMFLOAT3& posOrDir)
//{
//	//3갈래 발사
//	auto currentTime = std::chrono::high_resolution_clock::now();
//	auto durationTime = std::chrono::duration_cast<std::chrono::seconds>(currentTime - m_prevSkillInputTime[0]);
...
//}
//
//void ArcherSessionObject::Skill_2(const XMFLOAT3& posOrDir)
//{
//	auto currentTime = std::chrono::high_resolution_clock::now();
//	auto durationTime = std::chrono::duration_cast<std::chrono::seconds>(currentTime - m_prevSkillInputTime[1]);
//	if (m_skillCoolTime[1] > durationTime)	return;
...
//}
//
//void ArcherSessionObject::ExecuteCommonAttack(const XMFLOAT3& attackDir, int power)
//{
//	Room& roomRef = g_RoomManager.GetRunningRoomRef(m_roomId);
