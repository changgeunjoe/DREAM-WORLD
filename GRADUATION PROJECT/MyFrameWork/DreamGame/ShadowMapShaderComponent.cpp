...
void ShadowMapShaderComponent::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
	...
	//CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, m_pDepthTexture->GetTextures()); //¾À¿¡¼­?
	...
	CreateShaderResourceViews(pd3dDevice, m_pDepthTexture,0, RP_DEPTH_BUFFER, false);//Áß¿ä
